...
const features: Feature[] = [
  {
    icon: Brain,
    title: "Түвшин тодорхойлолт",
    description: "Хиймэл оюун ухаан таны математик, физик, хими, биологийн мэдлэгийг үнэлж, хаана анхаарах хэрэгтэйг нарийн тодорхойлно.",
    color: "from-blue-500 to-cyan-500",
  },
  {
    icon: Target,
    title: "Сул тал засах",
    description: "Алдаж буй сэдвүүдийг олж, тухайн хэсэгт төвлөрсөн дасгал, тайлбар хичээлүүдээр сул талыг бататгана.",
    color: "from-purple-500 to-pink-500",
  },
  {
    icon: Route,
    title: "Хувийн сургалтын зам",
    description: "7 хоногийн хуваарьтай, таны түвшинд тохирсон, зорилгод чиглэсэн сургалтын төлөвлөгөө автоматаар үүснэ.",
    color: "from-orange-500 to-red-500",
  },
  {
    icon: Users,
    title: "Ментор дэмжлэг",
    description: "МУИС, ШУТИС зэрэг их сургуульд элссэн ах эгч нараас зөвлөгөө авч, туршлагаас суралцах боломжтой.",
...
const testimonials: Testimonial[] = [
  {
    name: "Нармандах Б.",
    role: "МУИС Компьютерийн ухаан - 2024",
    content: "Studium-ийн AI систем миний математикийн сул талыг олж, тухайн хэсгийг нарийн дасгалаар бататгасан. Элсэлтийн шалгалтанд 780 оноо авсан!",
    rating: 5,
  },
  {
    name: "Сарангоо Д.",
    role: "ШУТИС Архитектур - 2024",
    content: "Менторуудын туршлага үнэхээр чухал байсан. Тэд яг юуг анхаарах хэрэгтэйг маш сайн мэддэг. Санаснаасаа илүү сайн оноо авлаа.",
    rating: 5,
  },
  {
    name: "Тэмүүлэн О.",
    role: "АШУҮИС Анагаахын сургууль - 2024",
    content: "Анагаахад элсэх нь миний мөрөөдөл байсан. Studium-ийн тусламжтайгаар биологи, химиа маш сайн бэлдэж, 810 оноо авч элссэн.",
    rating: 5,
  },
];

const steps: Step[] = [
  { step: 1, title: "Бүртгүүлэх", description: "2 минутад үнэгүй бүртгэл үүсгээрэй" },
  { step: 2, title: "Оношлогоо өгөх", description: "AI таны түвшин, сул талыг олно" },
  { step: 3, title: "Төлөвлөгөө авах", description: "Танд тохирсон 12 долоо хоногийн төлөвлөгөө" },
  { step: 4, title: "Амжилтад хүрэх", description: "Өдөр бүр дасгал хийж, ментороос зөвлөгөө аваарай" },
];
    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 overflow-x-hidden font-sans">
      ...
      <section className="py-12 sm:py-16 lg:py-24 bg-gray-50 dark:bg-gray-800">
        <div className="container mx-auto px-4">
          ...
          >
            <motion.div variants={fadeInUp}>
              <Badge variant="success" className="mb-4">Хэрхэн ажилладаг вэ?</Badge>
            </motion.div>
            <motion.h2
              variants={fadeInUp}
              className="text-2xl sm:text-3xl lg:text-4xl font-bold text-gray-900 dark:text-white mb-4"
