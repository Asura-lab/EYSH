        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12">
          ...
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center gap-2 mb-4">
              ...
              <span className="text-xl font-bold text-gray-900 dark:text-white">Studium</span>
            </Link>
            <p className="text-gray-500 dark:text-gray-400 mb-6 max-w-sm">
              Элсэлтийн шалгалтанд бэлдэх хамгийн ухаалаг арга зам. AI технологид суурилсан хувийн сургалтын төлөвлөгөө.
            </p>
            <div className="flex gap-4">
              <a href="#" className="w-10 h-10 bg-gray-200 dark:bg-gray-800 rounded-lg flex items-center justify-center hover:bg-blue-600 hover:text-white transition">
                <Facebook className="w-5 h-5" />
              </a>
              <a href="#" className="w-10 h-10 bg-gray-200 dark:bg-gray-800 rounded-lg flex items-center justify-center hover:bg-pink-600 hover:text-white transition">
                <Instagram className="w-5 h-5" />
              </a>
              <a href="#" className="w-10 h-10 bg-gray-200 dark:bg-gray-800 rounded-lg flex items-center justify-center hover:bg-blue-400 hover:text-white transition">
          ...
          {/* Links */}
          <div>
            <h4 className="text-gray-900 dark:text-white font-semibold mb-4">Бүтээгдэхүүн</h4>
            <ul className="space-y-3">
              {footerLinks.product.map((link) => (
                <li key={link.href}>
                  <Link href={link.href} className="hover:text-gray-900 dark:hover:text-white transition">
                    {link.label}
                  </Link>
                </li>
              ))}
          ...
          <div>
            <h4 className="text-gray-900 dark:text-white font-semibold mb-4">Компани</h4>
            <ul className="space-y-3">
          ...
          <div>
            <h4 className="text-gray-900 dark:text-white font-semibold mb-4">Холбоо барих</h4>
            <ul className="space-y-3">
              <li className="flex items-center gap-2">
                <Mail className="w-4 h-4 text-blue-500 dark:text-blue-400" />
                <span>info@studium.mn</span>
              </li>
              <li className="flex items-center gap-2">
              ...
              <li className="flex items-start gap-2">
                <MapPin className="w-4 h-4 text-blue-500 dark:text-blue-400 mt-1" />
